      ...
      <header className="relative flex items-center justify-between max-w-7xl mx-auto mb-24">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-amber-100/20 text-xl italic mt-1">Preserve your manuscripts for eternity.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          >
            ...
            <div className="text-center">
              <span className="block text-3xl font-bold text-amber-100/60">New Manuscript</span>
